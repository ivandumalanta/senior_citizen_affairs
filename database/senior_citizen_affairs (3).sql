...
--
-- Host: localhost:3306
-- Generation Time: Feb 12, 2025 at 06:47 PM
...
CREATE TABLE `events` (
  ...
  `request_type` enum('Walk-in','Document Submission') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(234234234236, 'mermae@gmail.com', 'roldan', 'mermae', 'de vera', '', 'Female', '1930-03-03', 'awai san jacinto pangasinan, Malasiqui, Pangasinan', 9912398598, 'private/documents/234234234236/doc_67a77fdb1f3b2.png', 'pending', NULL, 'Pensioner', 'Married', 'O+', 'Vocational', 'Self Employed', 'Roman Catholic', 'Mermae', '12441244@@', '2025-02-08 16:01:31.132658', '2025-02-08 16:01:31.132658', NULL),
