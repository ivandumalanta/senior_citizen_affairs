...
try {
    $sql = "SELECT osca_id, last_name, first_name, middle_name, suffix, sex FROM users WHERE status = 'pending' ORDER BY created_at ASC";
...
<body>
    ...
    <h1>Pending Applicants</h1><span><a href="approved_applicants.php">Approved Applicants</a></span>
